  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      text.innerHTML = words.map(word => 
        `<span class="word" style="display: inline-block;">${word.split('').map(letter => 
      ...
      letters.forEach(letter => {
        const handleMouseEnter = () => {
          ...
          hoverTl.to(letter, { rotation: 15, duration: 0.3, ease: "power2.out" })
          .to(letter, { rotation: -10, duration: 0.2, ease: "power2.inOut" })
          .to(letter, { rotation: 5, duration: 0.15, ease: "power2.inOut" })
          .to(letter, { rotation: 0, duration: 0.25, ease: "elastic.out(1, 0.5)" })
        }
