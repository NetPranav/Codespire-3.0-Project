  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={`fixed inset-0 z-50 pointer-events-none transition-all duration-600 ease-in-out ${
        ...
        <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
          <div
            className={`absolute top-1/4 left-1/4 w-2 h-2 bg-black rounded-full transition-all duration-1000 ${
              isLeaving ? "opacity-0 scale-0" : "opacity-5 scale-100"
            }`}
          ></div>
          <div
            className={`absolute bottom-1/3 right-1/3 w-1 h-1 bg-gray-400 rounded-full transition-all duration-1200 delay-200 ${
              isLeaving ? "opacity-0 scale-0" : "opacity-10 scale-100"
            }`}
          ></div>
          <div
            className={`absolute top-1/2 right-1/4 w-3 h-3 bg-black rounded-full transition-all duration-1400 delay-400 ${
        ...
        <div
          className={`min-h-screen bg-white flex items-center justify-center px-6 py-12 relative z-10 transition-all duration-500 ${
        ...
        >
          ...
          <div
            className={`absolute bottom-8 left-8 transition-all duration-500 delay-100 ${
              isLeaving
          ...
          <div
            className={`absolute top-60 right-8 transition-all duration-500 delay-75 ${
              isLeaving
                ? "opacity-0 translate-x-10"
                : "opacity-100 translate-x-0"
            }`}
          ...
          <div className="w-full max-w-4xl flex flex-col">
            ...
            <div
              className={`text-center mb-16 transition-all duration-500 delay-150 ${
                isLeaving
            ...
            {/* CONTENT SECTION */}
            <div
              className={`w-full flex flex-col md:flex-row items-start justify-between gap-16 md:gap-20 transition-all duration-500 delay-200 ${
