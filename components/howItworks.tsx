...
// import React from "react";
// import HeaderWORKS from "./howitworks-head";
// import gsap from "gsap";
// import { ScrollTrigger } from 'gsap/ScrollTrigger'
...
//   return (
//     <div
//       className={`h-[80vh] w-full flex flex-col justify-evenly items-center relative z-4 bg-[linear-gradient(to_bottom,rgba(0,0,0,0),rgba(0,0,0,0.8))]`}
//     >
//       <HeaderWORKS />
//       <div className="h-[90%] w-full flex items-center justify-evenly">
//         {steps.map((step, idx) => {
//           return (
//             <div
//               className={` rounded-2xl h-[200px] pl-4 aspect-6/3 flex flex-col items-start justify-center gap-2.5 bg-[rgba(0,0,0,0.5)] backdrop-blur-sm shadow-[0px_0px_2px_#fff] hover:scale-[1.1] transition-all duration-300 brightness-50 hover:brightness-100`}
//             >
//               <h1 className={`text-white text-2xl font-bold flex items-center gap-2.5`}> {step.icon} {step.title}</h1>
