...
//       <div className="container mx-auto p-4 md:p-8 lg:p-12 xl:p-16 pt-32">
//         {" "}
//         {/* Increased padding-top for content */}
//         <div className="grid grid-cols-3 grid-row-1 md:grid-cols-2 lg:grid-cols-4 gap-8 border-b border-gray-700 pb-8 mb-8">
//           {/* Company Info */}
//           <div className="col-span-1">
//             <Link href="/" className="flex items-center mb-4">
//               <Image
...
//                   {/* Example, use actual icon components */}
//                   <svg
//                     className="w-5 h-5"
//                     fill="currentColor"
//                     viewBox="0 0 24 24"
